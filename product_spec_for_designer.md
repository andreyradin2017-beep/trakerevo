# Спецификация приложения TrakerEvo (v1.0.0 Stable)
...
- **Жесты (Telegram-style)**:
  - **Свайп влево**: Быстрая архивация (желтая подложка, иконка архива).
  - **Свайп вправо**: Удаление (красная подложка, иконка корзины).
...
5. **Оказоустойчивость**: Приложение автоматически перезагружает страницу, если не может загрузить файл (например, при обновлении версии на сервере), обеспечивая бесшовный опыт.
